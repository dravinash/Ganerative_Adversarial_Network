...
def discriminator_network(in_shape=(28,28,1)):
...
def summarize_performance(epoch, generator_model, discriminator_model, dataset, latent_dim, n_samples=100):
...
def train(generator_model, discriminator_model, gan_model, dataset, latent_dim, n_epochs=500, n_batch=256):
...
discriminator_model = discriminator_network()
# create the generator
generator_model = generator_network(latent_dim)
# create the gan
